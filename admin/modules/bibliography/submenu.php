...
$menu[] = array('Label Barcode Color', MWB.'bibliography/lbc/label_barcode_warna_generator.php', 'Cetak label barcode warna');
...
//add by heru 2015
$menu[] = array(__('Label Barcodes Printing'), MWB.'bibliography/label_barcode_generator.php', __('Print Label Barcodes'));
